...
The 6th cluster appears to be the worst for fatalaties. Here are the terms associated with that cluster:
...
Once again, cluster 6 appears to be the most severe event cluster. Here are the terms in that cluster once again:
