...
Note the similarities between some of the fields: wind, flood, thunderstorm, winter, etc.. I am going to try to reduce some of the redundancies using techniques used for text mining ([I learned about most of this from here!](https://www.tidytextmining.com/index.html)).

```{r}
library(tidytext)

tokens <- storm %>% select(REFNUM, EVTYPE, PROPDMG, CROPDMG, INJURIES, FATALITIES) %>%
